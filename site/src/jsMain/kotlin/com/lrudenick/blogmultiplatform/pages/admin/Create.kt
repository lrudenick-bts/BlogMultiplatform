...
import com.lrudenick.blogmultiplatform.styles.EditorKeyStyle
            ...
            Column(
                ...
                SimpleGrid(numColumns = numColumns(base = 1, sm = 3)) {
                    Row(
                        modifier = Modifier
                            .margin(
                                right = if (breakpoint < Breakpoint.MD) 0.px else 24.px,
...
fun ThumbnailUploader(
    ...
    onThumbnailSelect: (fileName: String, base64Img: String) -> Unit
) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
